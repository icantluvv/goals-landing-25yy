  ...
  return (
    ...
    >
      <div className="flex-1">
        <div className="w-full h-full bg-Purple rounded-[25px] md:rounded-[35px] flex flex-col gap-y-[24px] p-[24px] md:p-[48px] min-w-[300px] md:min-w-auto shadow-md">
          ...
          <h2 className="text-white text-[1.75rem] md:text-[3.25rem] font-semibold select-none">
            Всего несколько шагов до старта!
          </h2>
        </div>
      </div>

      <div className="flex-2 flex md:flex-wrap gap-[24px]">
        {steps.map((step, index) => (
          <div
            key={index}
            className="w-full md:w-[calc(50%-12px)] bg-darkBlue/5 md:rounded-[35px] rounded-[25px] p-[24px] md:p-[48px] flex flex-col gap-y-[24px] md:gap-y-[48px] min-w-[300px] md:min-w-auto"
          >
        ...
        <div
          className="w-full md:w-[calc(50%-12px)] bg-darkBlue rounded-[25px] md:rounded-[35px] p-[24px] md:p-[48px] flex flex-col 
        justify-between gap-y-[96px] md:gap-y-[48px] relative min-w-[300px] md:min-w-auto overflow-hidden"
        >
          <Image
            src={trend}
            alt={"trend"}
